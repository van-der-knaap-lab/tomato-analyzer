...
IMPLEMENT_DYNAMIC(carpSize, CDialog)
carpSize::carpSize(CWnd* pParent /*=NULL*/)
	: CDialog(carpSize::IDD, pParent)
	, Ellipse_Value(75)
{
	clickSave = false;
}
...
BOOL carpSize::OnInitDialog() 
{
	CDialog::OnInitDialog();
	
	// TODO: Add extra initialization here
	Ellipse_Slider.SetRange(25, 100, TRUE);
...
void carpSize::DoDataExchange(CDataExchange* pDX)
{
...
void carpSize::OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar) 
{
...
BEGIN_MESSAGE_MAP(carpSize, CDialog)
...
void carpSize::OnNMCustomdrawSlider(NMHDR *pNMHDR, LRESULT *pResult)
{
